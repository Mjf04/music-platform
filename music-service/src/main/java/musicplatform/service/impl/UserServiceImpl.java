...
import musicplatform.enumeration.UserStatusEnum;
import musicplatform.mapper.FeedbackMapper;
import musicplatform.mapper.UserMapper;
    ...
    public Result updateUserAvatar(String avatarUrl) {
        ...
        if (oldAvatar != null && !oldAvatar.isEmpty()) {
            try {
                ...
                // 旧头像可能指向已删除的 bucket 或无效 URL，不应阻断新头像保存
            }
        }
