  ...
  <div class="h-full p-6 overflow-y-auto mr-16">
    <div v-if="songDetail" class="space-y-6">
      ...
      <div class="space-y-2">
        ...
        <div class="mt-4">
          <button
            @click="handleGoToLyric"
            class="w-full flex items-center justify-center gap-2 px-6 py-3 bg-activeMenuBg text-primary-foreground rounded-lg hover:bg-hoverMenuBg transition-colors"
          >
            <icon-material-symbols:music-note class="text-xl" />
            <span class="font-medium">查看歌词</span>
          </button>
        </div>
      </div>
