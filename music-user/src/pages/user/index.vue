    ...
    <div class="section">
      ...
      <div class="user-header">
        <div class="avatar-wrapper" @click="handleAvatarClick">
          <el-avatar
            :key="userStore.userInfo.avatarUrl || 'default'"
            :src="getImageUrl(userStore.userInfo.avatarUrl) || defaultAvatar"
            :size="100"
          />
          <!-- 悬停显示的更新提示 -->
