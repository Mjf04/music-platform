...
import UploadLyricDialog from "./form/upload-lyric.vue";
...
const openLyricDialog = row => {
  selectedSongId.value = row.songId;
  selectedLyric.value = row.lyric || "";
    ...
    >
      ...
      >
        ...
        <template v-slot="{ size, dynamicColumns }">
          ...
          <!-- 歌词编辑弹窗 -->
          <UploadLyricDialog
            v-if="showLyricDialog"
            :visible="showLyricDialog"
            :songId="selectedSongId"
            :current-lyric="selectedLyric"
            @update:visible="showLyricDialog = $event"
            @success="onSearch"
          />
        </template>
      </PureTableBar>
