...
import ManageSongsDialog from "./form/manage-songs.vue";
...
function openManageSongs(row) {
  console.log("openManageSongs 被调用", row);
  console.log("playlistId:", row.playlistId);
  console.log("title:", row.title);
  selectedPlaylistId.value = row.playlistId;
  selectedPlaylistTitle.value = row.title;
  showManageSongsDialog.value = true;
  console.log("showManageSongsDialog:", showManageSongsDialog.value);
}
...
<template>
  <div :class="['flex', 'justify-between', deviceDetection() && 'flex-wrap']">
    ...
    <ManageSongsDialog
      v-model:visible="showManageSongsDialog"
      :playlist-id="selectedPlaylistId"
      :playlist-title="selectedPlaylistTitle"
      @success="onSearch"
    />
  </div>
</template>
