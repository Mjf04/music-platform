...
export { FAKE_FILE_EXTENSIONS, FakeFileLoader, INFIX_NAME, LogLevels, OUTPUT_DIR, PORT, buildPackage, copyFakeFiles, createFakeMiddleware, createLogger, defineFakeRoute, generateFakeServer, getFakeFilePath, getRequestData, getWatchPaths, isFunction, parallelLoader, resolveIgnored, resolveOptions, resolvePluginOptions, simulateServerResponse, sleep, tryToJSON, version, vitePluginFakeServer };
